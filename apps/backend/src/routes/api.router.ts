...
apiRouter.post("/store/orders", requirePersistence, (req, res) => storefrontController.checkoutOrder(req, res));
...
apiRouter.post("/store/settings", requireRole("ADMIN"), requirePersistence, (req, res) => storefrontController.updateStoreSettings(req, res));
...
apiRouter.post("/import/single", requirePersistence, (req, res) => importCtrl.importSingle(req, res));
apiRouter.post("/import/bulk", requirePersistence, (req, res) => importCtrl.importBulk(req, res));
...
apiRouter.put("/products/:id", requirePersistence, (req, res) => productsCtrl.updateProduct(req, res));
...
apiRouter.post("/products/bulk-publish", validateBody(idsSchema), (req, res) => productsCtrl.bulkPublish(req, res));
apiRouter.post("/products/bulk-delete", requireRole("ADMIN"), validateBody(idsSchema), (req, res) => productsCtrl.bulkDelete(req, res));
...
apiRouter.post("/templates", requireRole("ADMIN"), requirePersistence, (req, res) => templatesController.createTemplate(req, res));
apiRouter.put("/templates/:id", requireRole("ADMIN"), requirePersistence, (req, res) => templatesController.updateTemplate(req, res));
