...
const webVariant = z.object({
  id: optionalText(128),
  sourceVariantId: optionalText(128),
  sourceSkuId: id,
  colorName: optionalText(300),
  colorNameEN: optionalText(300),
  sizeName: optionalText(300),
  sizeNameEN: optionalText(300),
...
export const productUpdateSchema = z.object({
  ...
  titleEN: z.string().trim().max(1_000).optional(),
  ...
  primaryImage: imageRef.optional(),
  ...
  metaDescription: z.string().max(2_000).optional(),
  ...
  warrantyPolicy: z.string().max(10_000).optional(),
  shippingPolicy: z.string().max(10_000).optional(),
